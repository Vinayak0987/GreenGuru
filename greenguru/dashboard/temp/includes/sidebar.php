    ...
    <div class="position-sticky pt-3 vh-100">
        ...
        <ul class="nav flex-column px-2">
            <li class="nav-item mb-1">
                <a class="nav-link text-white <?php echo (basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : ''); ?>" href="../admin_dashboard_cleaned/index.php">
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-white <?php echo (strpos($_SERVER['PHP_SELF'], '/users/') !== false) ? 'active' : ''; ?>" href="../admin_dashboard_cleaned/users/index.php">
                    <div class="d-flex align-items-center">
                        <div class="sidebar-icon">
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-white <?php echo (strpos($_SERVER['PHP_SELF'], '/products/') !== false) ? 'active' : ''; ?>" href="../admin_dashboard_cleaned/products/index.php">
                    <div class="d-flex align-items-center">
                        <div class="sidebar-icon">
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-white <?php echo (strpos($_SERVER['PHP_SELF'], '/orders/') !== false) ? 'active' : ''; ?>" href="../admin_dashboard_cleaned/orders/index.php">
                    <div class="d-flex align-items-center">
                        <div class="sidebar-icon">
            ...
            <li class="nav-item mb-1">
                <a class="nav-link text-white <?php echo (strpos($_SERVER['PHP_SELF'], '/settings/') !== false) ? 'active' : ''; ?>" href="#">
                    <div class="d-flex align-items-center">
                        <div class="sidebar-icon">
        ...
        <div class="position-absolute bottom-0 start-0 end-0 p-3">
            <div class="border-top border-secondary pt-3">
                ...
                <a href="../../../greenguru/Login page/login.html" class="btn btn-outline-light w-100 d-flex align-items-center justify-content-center">
